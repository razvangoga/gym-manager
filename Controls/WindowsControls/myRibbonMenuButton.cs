...
{
    public class myRibbonMenuButton : Button
    {
        #region About Constructor
        public myRibbonMenuButton()
        {
            ...
            this.ImageLocation = e_imagelocation.Left;
        ...
        #region Colors
        private Color _baseColor = Color.FromArgb(255, 255, 128);
        private Color _onColor = Color.Coral;
        private Color _pressColor = Color.LightSlateGray;

        private Color _baseStroke = Color.FromArgb(100, 76, 76, 38);
        private Color _onStroke = Color.FromArgb(100, 76, 76, 38);
        private Color _pressStroke = Color.FromArgb(100, 76, 76, 38);
        private Color _colorStroke = Color.FromArgb(100, 76, 76, 38);
        ...
        {
            base.OnGotFocus(e);
            this._baseColor = Color.LightBlue;
            UpdateLeave();
        }
        ...
        {
            base.OnLostFocus(e);
            this._baseColor = Color.FromArgb(255, 255, 128);
            UpdateLeave();
        }
            ...
            else
            {
                ...
                if (_keeppress)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (typeof(myRibbonMenuButton) == _control.GetType() & _control.Name != this.Name)
                            {
                                ((myRibbonMenuButton)(_control))._ispressed = false;
                                ((myRibbonMenuButton)(_control)).UpdateLeave();
                            }
                        }
                    }
                    catch { }
